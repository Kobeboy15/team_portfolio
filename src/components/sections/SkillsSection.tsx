  ...
  return (
    <Section id="skills" spacing="sm" className="bg-(--token-background)">
      <Heading
        size="display-48"
        as="h1"
        className="mx-7 text-display-48! md:text-display-96!"
      >
        Expertise/Skills
      </Heading>
      {skills.map((skill) => (
        <div
          key={skill.order}
          className="w-full mb-7 md:mb-0 md:h-screen pr-2 flex justify-end md:justify-center items-start md:items-center"
        >
