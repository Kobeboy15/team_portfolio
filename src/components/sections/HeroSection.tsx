    ...
    <Section id="hero" navHeight="72px">
      <div className="flex flex-col h-full">
        ...
        <div className="flex flex-col sm:flex-row sm:flex-1">
          <div className="flex flex-col items-end sm:items-start justify-start px-3 pt-20 sm:pl-3 md:pl-9 sm:pr-2 md:pr-5 gap-y-2 sm:gap-y-4">
          ...
          <div className="relative w-full sm:w-[380px] sm:h-[450px] md:w-[515px] md:h-[386px] xl:w-[773px] xl:h-[580px] xl:shrink-0 aspect-[773/580] xl:aspect-auto px-3 sm:px-0">
            <ImageFrame
              placement="hero"
              src="/images/hero/hero-image.webp"
              alt="Hero image"
              className="h-full w-full object-cover sm:relative sm:bottom-5 md:bottom-10"
            />
          </div>
        </div>
      </div>
