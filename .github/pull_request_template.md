...
- [ ] Matches ticket scope
- [ ] Code builds, no errors
- [ ] CodeRabbit essentials addressed (or noted below)
- [ ] Content source reviewed and implemented when applicable
